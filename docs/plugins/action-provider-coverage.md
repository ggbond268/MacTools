...
- `DuoStatus` displays battery and network snapshots in a separate menu-bar icon. Icon visibility and monitoring are configured in its settings; it has no repeatable system mutation to publish as an action.
