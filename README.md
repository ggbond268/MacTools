...
| Cleanup & maintenance | Explore disk usage visually, review large files and folders before moving them to Trash, review apps and their verified related data before uninstalling, clean disk and Xcode files, manage Homebrew and login items, eject disks, empty Trash, quit apps, repair quarantined apps, soft-restart macOS, and use physical Clean Mode. |
