...
enum DuoStatusIcon {
    ...
    private static func batteryRingColor(for snapshot: DuoSystemStatusSnapshot) -> NSColor? {
    ...
    private static func drawNetwork(_ snapshot: DuoSystemStatusSnapshot, color: NSColor) {
    ...
    private static func drawWiFi(_ wifi: DuoSystemStatusSnapshot.WiFi, color: NSColor) {
        let level: Int
